...
export const WORKSPACES = {
  ...
  grupoib: {
    ...
    kioskUnits: [
      ...
      {
        id: 'clinica-a',
        name: 'Faça Amigos, Centro de Terapia Comportamental',
        buttonLabel: 'Estagiários - Faça Amigos, Centro de Terapia Comportamental',
        loginLabel: 'Estagiário - Faça Amigos, Centro de Terapia Comportamental',
        kioskEmail: 'clinicaa@grupoib.internal',
        professionalButtonLabel: 'Profissionais PJ - Faça Amigos, Centro de Terapia Comportamental',
        professionalKioskEmail: 'pj-clinicaa@grupoib.internal',
        employeeButtonLabel: 'Funcionários CLT - Faça Amigos, Centro de Terapia Comportamental',
