...
export default function App() {
  ...
  const getPaeActivities = (intern) => {
    const activitiesList = [
      ...
      { title: "Aplicação de Entrevistas Semiestruturadas", desc: "Auxílio no roteiro e coleta de dados iniciais sobre a história de vida (anamnese) dos pacientes ingressantes." },
      { title: "Manejo de Prontuário Eletrônico", desc: "Alimentação de softwares de gestão clínica com informações cadastrais e dados básicos de evolução sob rígido sigilo." },
      { title: "Planejamento de Altas Terapêuticas", desc: "Estudo de critérios clínicos e preparação de documentos finais para o encerramento do processo de psicoterapia de pacientes." },
      { title: "Acompanhamento de Intervenções em Crise", desc: "Observação de protocols de emergência subjetiva e acolhimento imediato sob supervisão direta de profissionais." },
      { title: "Desenvolvimento de Recursos Lúdicos", desc: "Confecção e adaptação de jogos, brinquedos e cartilhas educativas para facilitação do diálogo com crianças." },
      { title: "Suporte na Elaboração de Laudos", desc: "Auxílio na estruturação de rascunhos de laudos e pareceres psicológicos de acordo com as normas vigentes do CFP." },
      { title: "Análise de Queixas Escolares", desc: "Avaliação sistemática de relatos pedagógicos e familiares referentes a dificuldades de aprendizagem e comportamento infantil." },
      { title: "Tabulação de Pesquisas de Clima", desc: "Compilação de questionários de satisfação interna de colaboradores e pacientes para relatórios de gestão da qualidade." },
      { title: "Revisão de Práticas de Biossegurança", desc: "Atualização e fiscalização de rotinas de higienização de consultórios e materiais de atendimento presencial." },
      { title: "Orientação sobre Encaminhamentos", desc: "Apoio na busca e indicação de serviços de saúde da rede pública ou privada parceira para demandas complementares." },
      { title: "Elaboração de Diários de Campo", desc: "Registro reflexivo e diário sobre as impressões práticas do cotidiano da clínica para fins de aprendizado e supervisão." },
      { title: "Mapeamento de Rede Socioassistencial", desc: "Levantamento de órgãos públicos (CRAS, CREAS, CAPS) do entorno para facilitar encaminhamentos assertivos." },
      { title: "Organização de Acervo Técnico", desc: "Catalogação e manutenção da biblioteca de livros de psicologia e manuais de testes disponíveis no consultório." },
      { title: "Auxílio em Grupos de Psicoeducação", desc: "Apoio na condução de reuniões temáticas sobre ansiedade, depressão, sono e hábitos saudáveis para pacientes." },
      { title: "Discussão de Casos Interdisciplinares", desc: "Participação em debates integrados com profissionais de outras áreas, como psiquiatria, pedagogia e fonoaudiologia." },
      { title: "Atividades de Orientação Vocacional", desc: "Auxílio na elaboração de dinâmicas e roteiros para facilitação de processos de escolha de carreira e profissão." },
      { title: "Monitoramento de Lista de Espera", desc: "Triagem e contato telefônico de atualização com pacientes aguardando vagas para atendimento psicoterápico." },
      { title: "Preparação de Apresentações Clínicas", desc: "Montagem de slides e estudos de caso em formato acadêmico para apresentação em seminários internos da Porto Terapia." },
      { title: "Suporte na Gestão de Agendamentos", desc: "Auxílio no remanejamento de horários e confirmação de presença de pacientes para otimização das salas de atendimento." },
      { title: "Análise da Demanda e Perfil Clínico", desc: "Estudo estatístico e epidemiológico dos principais motivos de busca por psicoterapia no banco de dados da clínica." },
      { title: "Auxílio na Condução de Roleplayings", desc: "Participação em simulações de técnicas clínicas durante reuniões de treinamento da equipe." },
      { title: "Acompanhamento de Terapia de Casal", desc: "Observação assistida ou estudo de prontuários focados na dinâmica conjugal e comunicação familiar." },
      { title: "Elaboração de Manuais de Procedimentos", desc: "Organização de guias práticos sobre o funcionamento administrativo dos consultórios para novos estagiários." },
      { title: "Avaliação de Programas de Intervenção", desc: "Coleta de feedbacks e tabulação de dados sobre a eficácia de projetos terapêuticos grupais específicos." },
      { title: "Observação de Atendimentos Online", desc: "Acompanhamento de sessões mediadas por tecnologias, aprendendo sobre as diretrizes específicas de telessaúde." },
      { title: "Auxílio em Oficinas de Estimulação Cognitiva", desc: "Apoio no planejamento e execução de atividades de memória e atenção para idosos ou crianças." },
      { title: "Diagnóstico Institucional", desc: "Mapeamento de processos e fluxos de trabalho da clínica buscando gargalos no atendimento ao paciente." },
      { title: "Estudo de Psicopatologia Geral", desc: "Leitura e discussão do DSM-5 e CID-11 voltados para a caracterização sindrômica em ambiente de prática." },
      { title: "Apoio na Integração de Novos Estagiários", desc: "Condução de visitas integrativas e explicação do espaço físico da clínica aos novos integrantes." },
      { title: "Desenvolvimento de Roteiros de Anamnese", desc: "Atualização de questionários de entrevista clínica inicial baseando-se em novas evidências." },
      { title: "Participação em Webinars Técnicos", desc: "Acompanhamento de treinamentos virtuais e palestras organizadas pela clínica para atualização científica." },
      { title: "Investigação de Abandono de Tratamento", desc: "Realização de contatos de feedback para entender os motivos de evasão ou desistência de terapias." },
      { title: "Auxílio na Organização de Eventos", desc: "Suporte logístico em simpósios, palestras ou workshops comunitários promovidos pela clínica." },
      { title: "Redação de Atas de Reunião", desc: "Registro formal das decisões tomadas e dos pontos discutidos em reuniões clínicas e administrativas da equipe." },
      { title: "Apoio em Práticas de Inclusão Escolar", desc: "Elaboração de estratégias comportamentais para auxiliar pacientes com necessidades educacionais especiais." },
      { title: "Análise de Eficácia Terapêutica", desc: "Comparação de escalas psicométricas aplicadas no início e no meio do tratamento para avaliar a melhora do paciente." },
      { title: "Estudo sobre Dependência Química", desc: "Leitura dirigida e discussão de casos práticos relacionados ao manejo de pacientes com uso problemático de substâncias." },
      { title: "Práticas de Escuta Ativa Adaptada", desc: "Exercícios de escuta empática e acolhimento sob a ótica de diferentes abordagens fenomenológico-existenciais." },
      { title: "Desenvolvimento de Materiais para Redes Sociais", desc: "Criação de pequenos informativos contendo dicas de saúde mental revisados pelo responsável técnico." },
      { title: "Apoio na Padronização de Fichas", desc: "Uniformização da identidade visual e do conteúdo das fichas de evolução diária de atendimentos." },
      { title: "Estudo de Farmacologia Aplicada à Psicologia", desc: "Análise do impacto de psicofármacos na conduta clínica de pacientes sob acompanhamento conjunto." },
      { title: "Observação de Técnicas Corporais em Psicoterapia", desc: "Acompanhamento de abordagens psicocorporais ou técnicas de relaxamento sob supervisão direta." },
      { title: "Auxílio no Registro de Ouvidoria", desc: "Catalogação de sugestões, críticas e elogios recebidos na recepção para análise de melhoria contínua." },
      { title: "Análise de Textos de Filosofia e Psicologia", desc: "Discussão de conceitos epistemológicos que fundamentam a prática da psicologia contemporânea." },
      { title: "Apoio em Terapias Baseadas em Evidências", desc: "Estudo de protocolos da terapia cognitivo-comportamental para transtornos específicos de ansiedade." },
      { title: "Planejamento de Sessões de Arteterapia", desc: "Auxílio na escolha de materiais plásticos e técnicas expressivas para atendimentos de grupos infantis." },
      { title: "Estudo de Casos de Violência Doméstica", desc: "Discussão e análise dos fluxos de denúncia e proteção de direitos aplicados a casos específicos." },
      { title: "Mapeamento de Barreiras de Acessibilidade", desc: "Avaliação do ambiente físico e de comunicação da clínica para garantir acesso universal." },
      { title: "Auxílio em Práticas de Mindful Eating", desc: "Acompanhamento de dinâmicas alimentares voltadas ao autocuidado em programas de perda de peso." },
      { title: "Estudo sobre Luto e Perdas", desc: "Discussão teórica e análise de estratégias de acolhimento para pacientes vivenciando perdas significativas." },
      { title: "Desenvolvimento de Inventários de Recursos Pessoais", desc: "Ajuda na catalogação de pontos fortes e habilidades de coping dos pacientes sob acompanhamento." },
      { title: "Análise de Padrões de Sono e Estresse", desc: "Monitoramento de escalas de rotina dos pacientes para identificar fatores desencadeantes de sintomas." },
      { title: "Apoio em Grupos de Desenvolvimento de Habilidades Sociais (THS)", desc: "Planejamento de treinos de assertividade e autoexpressão." },
      { title: "Estudo de Neuropsicologia do Desenvolvimento", desc: "Discussão do impacto de lesões ou atrasos de neurodesenvolvimento no comportamento infantil." },
      { title: "Observação de Psicoterapia Breve Focal", desc: "Análise de estratégias de intervenção rápida baseadas na identificação imediata do foco do conflito." },
      { title: "Análise de Aspectos de Gênero e Diversidade", desc: "Discussão das diretrizes do CFP para um atendimento clínico ético e livre de discriminação." },
      { title: "Apoio na Produção Científica Interna", desc: "Auxílio no levantamento de dados anonimizados para publicação de artigos com base na atuação da clínica." },
      { title: "Estudo de Abordagens Sistêmicas", desc: "Leitura orientada e discussão sobre dinâmicas e ciclos vitais das famílias atendidas na clínica." },
      { title: "Práticas de Autoavaliação e Feedback", desc: "Elaboração de relatórios sobre o próprio desempenho do estagiário para discussão em supervisão individual." },
